        ...
        <div className="bg-white w-full flex flex-col gap-5 px-3 md:px-16 lg:px-28 md:flex-row text-[#161931]">
            <aside className="hidden py-4 md:w-1/3 lg:w-1/4 md:block">
                <div className="sticky flex flex-col gap-2 p-4 text-sm border-r border-indigo-100 top-12">
                    ...
                    <Link href="/"
                        className="md:mt-80 flex items-center px-3 py-2.5 font-semibold hover:text-indigo-900 hover:border hover:rounded-full">
                        Home
                    </Link>
                            ...
                            <div className="items-center mt-8 sm:mt-14 text-[#202142]">
                                ...
                                <div
                                    ...
                                    <div className="w-full">
                                        <label htmlFor="first_name"
                                            className="block text-sm font-medium text-indigo-900 dark:text-white">Your
                                            Employ name</label>
                                ...
                                <div className="">
                                    <label htmlFor="profession"
                                        className="block text-sm font-medium text-indigo-900 dark:text-white">Profession</label>
